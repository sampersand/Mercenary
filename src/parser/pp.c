...
void pp_decl_post(ast_visitor_t* visitor, decl_t* decl) { printf(")"); }
...
void pp_stmt_pre(ast_visitor_t* visitor, stmt_t* stmt) { printf("(stmt "); }

void pp_stmt_post(ast_visitor_t* visitor, stmt_t* stmt) { printf(")"); }
...
void pp_null_expr(ast_visitor_t* visitor) { printf("null"); }
